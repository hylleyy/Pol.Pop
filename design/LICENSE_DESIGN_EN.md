# Pol.Pop: Design Assets & Visual Identity License
...
- **Permitted Use**: You are granted a non-exclusive, non-transferable license to view and execute these assets solely as part of the original software or for the purpose of evaluating its structure and content.

- **Media Rights**: You are permitted to capture and share screenshots or video recordings (for promotion, criticism, reviews, or social media demonstrations), provided that the raw asset files are not distributed separately.

- **Prohibited Acts**: Unless explicitly authorized in writing, you may not:
	- Extract, reuse, or modify the assets for use in standalone software or commercial projects.
...
- **The Human Touch & Ethics**: We prioritize human expression and real accessibility. We reserve the right to distance our brand from works or contexts generated in a way that does not align with our creative ethics and social commitment (e.g., images generated primarily through generative Artificial Intelligence).

- **Safety and Respect**: Permission for use is automatically revoked for any content or platforms that promote hate speech, illegal activities, or discriminatory behavior. We maintain a zero-tolerance policy for content that harms the safety or integrity of the communities served by the project.
